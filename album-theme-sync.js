(() => {
  ...
  const MOBILE_ASSET_VERSION = 'challengers-gaeul-liz-swap-v58';
  ...
  function loadMobileAssets() {
    ...
    if (page === 'members') appendStylesheet('mobile-signature-result-v52.css');
    ...
    appendStylesheet('mobile-header-members-v38.css');
