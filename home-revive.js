(() => {
  ...
  const VERSION_CARD = {
    ...
    spoilers: {
      ...
      image: 'https://pbs.twimg.com/media/G_rOkQMbAAAQ3UB.jpg',
      alt: 'LIZ in the REVIVE+ SPOILERS press-conference concept set',
    ...
    'loved-ive': {
      ...
      image: 'assets/revive/member-cards/loved-ive/gaeul.jpg?v=mobile-spoilers-card-layer-v41',
