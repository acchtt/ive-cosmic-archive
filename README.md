...
After adding or changing a Pages binding or secret, create a fresh production deployment before testing the associated Function. The deployment must be created after all required production bindings and secrets have been saved.
